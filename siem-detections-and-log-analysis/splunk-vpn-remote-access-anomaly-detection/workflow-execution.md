...
<details>
<summary><strong>▶ Phase 1 — Validate JSON Field Extraction and Dataset Scope</strong><br>
→ ensuring VPN logs are accessible and structured fields can be queried
</summary><br>

**Goal:** Ensure VPN logs are accessible and structured fields can be queried.

##### 🔷 Phase 1.1 — Run a broad search against the dataset to confirm events are indexed.

```spl
index="main"
```

##### 🔷 Phase 1.2 — Apply `spath` to extract JSON fields for use in subsequent aggregations.
```spl
index="main"
| spath
```
...
<details>
<summary><strong>▶ Phase 2 — Analyze Activity by User and Country</strong><br>
→ identifying accounts generating VPN sessions across multiple geographic regions
</summary><br>
...
<details>
<summary><strong>▶ Phase 3 — Identify Failed Authentication Attempts</strong><br>
→ surfacing potential brute-force or credential misuse patterns
</summary><br>
...
<details>
<summary><strong>▶ Phase 4 — Analyze Geographic Distribution Within a Single Country</strong><br>
→ establishing baseline regional activity patterns
</summary><br>
...
<details>
<summary><strong>▶ Phase 5 — Analyze Secure Session Terminations</strong><br>
→ identifying IPs frequently terminating encrypted VPN sessions
</summary><br>
...
<details>
<summary><strong>▶ Phase 6 — Baseline Session Outcomes</strong><br>
→ determining distribution of session outcomes across the dataset
</summary><br>
