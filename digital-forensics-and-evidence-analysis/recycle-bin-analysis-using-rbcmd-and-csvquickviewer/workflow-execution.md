...
> Note:</br>**RBCmd** — a command-line forensic utility used to parse Windows Recycle Bin artifacts. Recycle Bin metadata can preserve information such as the original file path, file size, deletion timestamp, and user-specific Recycle Bin location.</br>
