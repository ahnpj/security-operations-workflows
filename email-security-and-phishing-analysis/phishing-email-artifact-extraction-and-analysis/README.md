...
| `phishing-analysis-report.md` | Formal phishing analysis and response documentation. | Provides a structured report including email description, collected artifacts, detailed artifact analysis, and recommended defensive measures to support incident response and containment decisions. |
