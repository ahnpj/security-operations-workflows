...
| **digital-forensics-and-evidence-analysis** | Digital forensics and evidence analysis workflows focused on acquiring, validating, examining, interpreting, and correlating digital evidence from storage media, memory, files, operating systems, and forensic artifacts. Workflows include forensic disk image analysis, file system identification, partition analysis, metadata examination, file carving, hash validation, memory acquisition, process dumping, browser artifact collection, evidence integrity verification, forensic imaging, Windows artifact analysis, shortcut (.LNK) analysis, Prefetch analysis, Jump List analysis, execution evidence review, user activity reconstruction, artifact correlation, timeline development, and foundational DFIR investigation methodologies. |
