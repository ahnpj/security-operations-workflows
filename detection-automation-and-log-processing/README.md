...
Begin with `workflow-execution.md` inside an investigation folder to see the step-by-step technical execution of the task, including scripts, commands, parsing logic, validation checks, and output examples.
